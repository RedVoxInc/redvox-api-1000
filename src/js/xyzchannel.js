...
proto.XyzChannel.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    xSamplesList: (f = jspb.Message.getRepeatedFloatingPointField(msg, 4)) == null ? undefined : f,
    ySamplesList: (f = jspb.Message.getRepeatedFloatingPointField(msg, 5)) == null ? undefined : f,
    zSamplesList: (f = jspb.Message.getRepeatedFloatingPointField(msg, 6)) == null ? undefined : f,
...
/**
 * @param {string} value
 * @return {!proto.XyzChannel} returns this
 */
...
proto.XyzChannel.prototype.clearXSampleStatistics = function() {
  return this.setXSampleStatistics(undefined);
};
...
proto.XyzChannel.prototype.clearYSampleStatistics = function() {
  return this.setYSampleStatistics(undefined);
};
...
proto.XyzChannel.prototype.clearZSampleStatistics = function() {
  return this.setZSampleStatistics(undefined);
};
