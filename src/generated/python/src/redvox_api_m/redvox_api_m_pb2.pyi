...
class RedvoxPacketM(google___protobuf___message___Message):
    ...
    class SummaryStatistics(google___protobuf___message___Message):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"count",b"count",u"max",b"max",u"mean",b"mean",u"metadata",b"metadata",u"min",b"min",u"range",b"range",u"variance",b"variance"]) -> None: ...
