SUB_API: float = 9.0  # redvox-api-1000 -> build_protos.sh -> insert_sub_api.py on 2020-10-19 20:51:26.298822
...
_REDVOXPACKETM_STATIONINFORMATION_APPSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='redvox_api_m.RedvoxPacketM.StationInformation.AppSettings.metadata', index=27,
