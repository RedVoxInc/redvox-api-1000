#define SUB_API 10.0  // redvox-api-1000 -> build_protos.sh -> insert_sub_api.py on 2020-11-17 21:34:38.120130
...
typedef GPB_ENUM(RedvoxPacketM_StationInformation_MetricsRate) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  RedvoxPacketM_StationInformation_MetricsRate_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  RedvoxPacketM_StationInformation_MetricsRate_Unknown = 0,
  RedvoxPacketM_StationInformation_MetricsRate_OncePerSecond = 1,
  RedvoxPacketM_StationInformation_MetricsRate_OncePerPacket = 2,
};
 ...
 * the time this source was generated.
 **/
BOOL RedvoxPacketM_StationInformation_MetricsRate_IsValidValue(int32_t value);
...
typedef GPB_ENUM(RedvoxPacketM_StationInformation_StationMetrics_ScreenState) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  RedvoxPacketM_StationInformation_StationMetrics_ScreenState_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  /** Unknown screen state */
  RedvoxPacketM_StationInformation_StationMetrics_ScreenState_UnknownScreenState = 0,

  /** Screen is turned on */
  RedvoxPacketM_StationInformation_StationMetrics_ScreenState_On = 1,

  /** Screen is turned off */
  RedvoxPacketM_StationInformation_StationMetrics_ScreenState_Off = 2,

  /** Station is running in headless mode and does not utilize a screen */
  RedvoxPacketM_StationInformation_StationMetrics_ScreenState_Headless = 3,
};
 ...
 * the time this source was generated.
 **/
BOOL RedvoxPacketM_StationInformation_StationMetrics_ScreenState_IsValidValue(int32_t value);
...
typedef GPB_ENUM(RedvoxPacketM_StationInformation_AppSettings_InputSensor) {
  ...
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_AccelerometerFast = 2,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_AmbientTemperature = 3,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Audio = 4,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_CompressedAudio = 5,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Gravity = 6,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Gyroscope = 7,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_GyroscopeFast = 8,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_ImagePerSecond = 9,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_ImagePerPacket = 10,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Light = 11,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_LinearAcceleration = 12,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Location = 13,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Magnetometer = 14,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_MagnetometerFast = 15,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Orientation = 16,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Pressure = 17,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Proximity = 18,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_RelativeHumidity = 19,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_RotationVector = 20,
  RedvoxPacketM_StationInformation_AppSettings_InputSensor_Velocity = 21,
};
 ...
 **/
GPB_FINAL @interface RedvoxApiMRoot : GPBRootObject
@end
 ...
 **/
GPB_FINAL @interface RedvoxPacketM : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_StationInformation : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_StationInformation_ServiceUrls : GPBMessage
...
typedef GPB_ENUM(RedvoxPacketM_StationInformation_StationMetrics_FieldNumber) {
  ...
  RedvoxPacketM_StationInformation_StationMetrics_FieldNumber_ScreenStateArray = 13,
  RedvoxPacketM_StationInformation_StationMetrics_FieldNumber_ScreenBrightnessArray = 14,
  RedvoxPacketM_StationInformation_StationMetrics_FieldNumber_Metadata = 15,
};

/**
 * Collection of station state and performance metrics
 **/
GPB_FINAL @interface RedvoxPacketM_StationInformation_StationMetrics : GPBMessage
...
// |screenStateArray| contains |RedvoxPacketM_StationInformation_StationMetrics_ScreenState|
@property(nonatomic, readwrite, strong, null_resettable) GPBEnumArray *screenStateArray;
/** The number of items in @c screenStateArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger screenStateArray_Count;

/** Screen brightness as a percentage */
@property(nonatomic, readwrite, strong, null_resettable) GPBFloatArray *screenBrightnessArray;
/** The number of items in @c screenBrightnessArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger screenBrightnessArray_Count;
...
typedef GPB_ENUM(RedvoxPacketM_StationInformation_AppSettings_FieldNumber) {
  ...
  RedvoxPacketM_StationInformation_AppSettings_FieldNumber_MetricsRate = 28,
  RedvoxPacketM_StationInformation_AppSettings_FieldNumber_Metadata = 29,
};

/**
 * A message that encapsulates the state of the app settings
 **/
GPB_FINAL @interface RedvoxPacketM_StationInformation_AppSettings : GPBMessage
...
@property(nonatomic, readwrite) RedvoxPacketM_StationInformation_MetricsRate metricsRate;
...
/**
 * Fetches the raw value of a @c RedvoxPacketM_StationInformation_AppSettings's @c metricsRate property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
...
/**
 * Sets the raw value of an @c RedvoxPacketM_StationInformation_AppSettings's @c metricsRate property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_TimingInformation : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_TimingInformation_SynchExchange : GPBMessage
...
typedef GPB_ENUM(RedvoxPacketM_Sensors_FieldNumber) {
  ...
  RedvoxPacketM_Sensors_FieldNumber_Velocity = 17,
  RedvoxPacketM_Sensors_FieldNumber_Metadata = 18,
};
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors : GPBMessage
...
/** m/s */
@property(nonatomic, readwrite, strong, null_resettable) RedvoxPacketM_Sensors_Xyz *velocity;
/** Test to see if @c velocity has been set. */
@property(nonatomic, readwrite) BOOL hasVelocity;
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors_Audio : GPBMessage
...
GPB_FINAL @interface RedvoxPacketM_Sensors_CompressedAudio : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors_Single : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors_Location : GPBMessage
...
GPB_FINAL @interface RedvoxPacketM_Sensors_Location_BestLocation : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors_Location_BestLocation_BestTimestamp : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors_Xyz : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_Sensors_Image : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_EventStream : GPBMessage
...
GPB_FINAL @interface RedvoxPacketM_EventStream_Event : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_SamplePayload : GPBMessage
 ...
 * Used to store collections of samples, their unit, and the statistics for those samples.
 **/
GPB_FINAL @interface RedvoxPacketM_TimingPayload : GPBMessage
 ...
 **/
GPB_FINAL @interface RedvoxPacketM_SummaryStatistics : GPBMessage
 ...
 **/
GPB_FINAL @interface EncryptedRedvoxPacketM : GPBMessage
...
GPB_FINAL @interface EncryptedRedvoxPacketM_Header : GPBMessage
 ...
 **/
GPB_FINAL @interface AcquisitionRequest : GPBMessage
 ...
 **/
GPB_FINAL @interface AcquisitionResponse : GPBMessage
 ...
 **/
GPB_FINAL @interface SynchRequest : GPBMessage
...
GPB_FINAL @interface SynchResponse : GPBMessage
