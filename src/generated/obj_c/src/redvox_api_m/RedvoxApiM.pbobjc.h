#define SUB_API 10.0  // redvox-api-1000 -> build_protos.sh -> insert_sub_api.py on 2020-11-17 22:21:03.656757
...
typedef GPB_ENUM(RedvoxPacketM_StationInformation_StationMetrics_FieldNumber) {
  ...
  RedvoxPacketM_StationInformation_StationMetrics_FieldNumber_ScreenBrightness = 14,
...
@property(nonatomic, readwrite, strong, null_resettable) RedvoxPacketM_SamplePayload *screenBrightness;
/** Test to see if @c screenBrightness has been set. */
@property(nonatomic, readwrite) BOOL hasScreenBrightness;
